...
bool MCCStringFormat(char*& r_string, const char *p_format, ...)
{
	...
	va_end(t_args);
#elif defined(TARGET_PLATFORM_MACOS) || defined(_LINUX) || defined(TARGET_SUBPLATFORM_IPHONE) || defined(TARGET_SUBPLATFORM_ANDROID) || defined(_LINUX_SERVER) || defined(__EMSCRIPTEN__)
	va_start(t_args, p_format);
