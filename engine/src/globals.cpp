...
MCObjectPtr MCerrorptr;
MCObjectPtr MCerrorlockptr;
MCObjectPtr MCtargetptr;
MCObjectPtr MCmenuobjectptr;
...
void X_clear_globals(void)
{
	...
	MCdynamiccard = nil;
	MCdynamicpath = False;
	memset(&MCerrorptr, 0, sizeof(MCObjectPtr));
    memset(&MCerrorlockptr, 0, sizeof(MCObjectPtr));
    memset(&MCtargetptr, 0, sizeof(MCObjectPtr));
    memset(&MCmenuobjectptr, 0, sizeof(MCObjectPtr));
	MCsavegroupptr = nil;
