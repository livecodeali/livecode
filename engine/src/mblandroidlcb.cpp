...
extern "C" JNIEXPORT void JNICALL Java_com_runrev_android_LCBInvocationHandler_doNativeListenerCallback(JNIEnv *env, jobject object, jlong handler, jobject p_method, jobjectArray p_args) __attribute__((visibility("default")));
